function executeClick(descriptionObject){
    ...
    var headerDescription = 
        ...
        + languageLocalizationSqlDescription.detailDescriptionComment 
        + '</div><div class="comment_block"><pre>' 
        + descriptionObject.comment 
        + '</pre></div>';
...
function createParamsTable(params){
    var headerTableParam = 
        '<div class=label_block>' 
        + languageLocalizationSqlDescription.detailDescriptionParams 
        + '</div><div class="params_block"><table class="table"><tr><th>' 
        + languageLocalizationSqlDescription.detailDescriptionParamsColumnName 
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionParamsColumnType  
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionParamsColumnTytle 
        + '</th></tr>';
    ...
    if (paramConcat == ''){
        resultTableParam='<div class=label_block>' + languageLocalizationSqlDescription.detailDescriptionParams  + '</div><div class="params_block"><p>' + languageLocalizationSqlDescription.detailDescriptionParamsNo + '</p></div>'
    } else {
...
function createFieldsTable(fields){
    var headerTableField = 
        '<div class=label_block>' 
        + languageLocalizationSqlDescription.detailDescriptionFields 
        + '</div><div class="fields_block"><table class="table"><tr><th>' 
        + languageLocalizationSqlDescription.detailDescriptionFieldsColumnName
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionFieldsColumnType
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionFieldsColumnTytle
        + '</th></tr>';
    ...
    if (fieldConcat == ''){
        resultTableFields='<div class=label_block>' +  languageLocalizationSqlDescription.detailDescriptionFields  + '</div><div class="fields_block"><p>' + languageLocalizationSqlDescription.detailDescriptionFieldsNo + '</p></div>'
    } else {
...
function createLogsTable(logs){
    var headerTableLog = 
        '<div class=label_block>' 
        + languageLocalizationSqlDescription.detailDescriptionLogs
        + '</div><div class="logs_block"><table class="table"><tr><th>' 
        + languageLocalizationSqlDescription.detailDescriptionLogsColumnDateChange
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionLogsColumnType
        + '</th><th>' 
        + languageLocalizationSqlDescription.detailDescriptionLogsColumnTytle
        + '</th></tr>';
    ...
    var resultTableLog;
    if (logConcat == ''){
        resultTableLog='<div class=label_block>' + languageLocalizationSqlDescription.detailDescriptionLogs + '</div><div class="logs_block"><p>' + languageLocalizationSqlDescription.detailDescriptionLogsNo + '</p><div>'
    } else {
